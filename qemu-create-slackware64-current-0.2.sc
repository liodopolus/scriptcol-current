...
start_overlay() {
	...
	qemu-kvm -enable-kvm -cpu qemu64,+ssse3,+sse4.1,+sse4.2,+x2apic -smp cores=2,threads=2,sockets=1 -soundhw all -k de -localtime -usb -usbdevice tablet -net nic -net user,smb=/tmp/ -vga std -hda "$(basename $IMG .raw).ovl" -hdb qemu-exchange-6G-2015-04.raw -m 4096
